...
"C:\Users\Rohit Sudhakar\AppData\Local\Programs\MiKTeX\miktex\bin\x64\xelatex.exe" -interaction=nonstopmode -halt-on-error -file-line-error -quiet -output-directory "C:\Users\Rohit Sudhakar\Desktop\Coding\patch-resume\temp_latex" "C:\Users\Rohit Sudhakar\Desktop\Coding\patch-resume\temp_latex\resume_latex-1758416316503.tex"
